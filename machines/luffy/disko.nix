...
{ config, ... }:
{
  disko.devices = {
    disk.main = {
      type = "disk";
      device = "/dev/nvme0n1"; # Standard for Acer Nitro 5
      content = {
        type = "gpt";
        partitions = {
          boot = {
          ...
          swap = {
            ...
            content = {
              ...
              passwordFile = "/tmp/secret.key"; # Placeholder until sops/facts setup
              content = {
                type = "swap";
                discardPolicy = "both";
                resumeDevice = true; # Allow hibernation to this partition
              };
            };
          };
          luks = {

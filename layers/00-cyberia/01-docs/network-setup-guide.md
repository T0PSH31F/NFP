...
|-----------|------------|----------------|-------------|--------------|------------------|-----------------------|
| `nami` | `nami` | Cloud Control Plane / Headscale | `nami.grandlix.net` | `47.254.90.69` | 22 (SSH), 80 (HTTP), 443 (HTTPS), 8086 (Headscale) | Tailscale coordination, Kong Gateway, Hermes, gno sync |
...
ssh root@nami.grandlix.net "headscale nodes list"
...
curl -sf http://nami.grandlix.net:8090/status    # nami Kong Gateway

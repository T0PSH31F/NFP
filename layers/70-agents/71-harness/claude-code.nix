  ...
  nixos =
    ...
    lib.mkIf cfg.enable {
      ...
      environment.sessionVariables = {
        ANTHROPIC_BASE_URL_KONG_ER = "http://127.0.0.1:8090/v1";
        ANTHROPIC_BASE_URL_KONG_OMNI = "http://127.0.0.1:8090/omni/v1";
        ANTHROPIC_BASE_URL_KONG_FREE = "http://127.0.0.1:8090/llm/free/v1";
        ANTHROPIC_BASE_URL_KONG_FRONTIER = "http://127.0.0.1:8090/llm/frontier/v1";
